...
public class Readcomments extends ListActivity {
   ...
   // private static final String READ_COMMENTS_URL = "http://xxx.xxx.x.x:1234/webservice/comments.php";
    ...
    //testing on Emulator:
    private static final String READ_COMMENTS_URL = "http://10.0.2.2/campus_connect/comments.php";
  ...
  //JSON IDS:
   ...
   //An array of all of our comments
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.readcomments);   
    }
    ...
    private void updateList() {
		...
		ListAdapter adapter = new SimpleAdapter(this, mCommentList,
				R.layout.single_comment, new String[] { TAG_TITLE, TAG_MESSAGE,
						TAG_USERNAME,TAG_POST_ID }, new int[] { R.id.title, R.id.message,
						R.id.username,R.id.pid });
